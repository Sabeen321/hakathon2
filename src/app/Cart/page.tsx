...
export default function Cart() {
  return (
    <>
      ...
      <Image src="/pictures/ShopeHero.png" width={1440} height={316} alt="ShopeHero"></Image>
...
<div className="flex justify-evenly items-center gap-1">
          <Image  src="/pictures/sofaaa.png" className="lightBG" width={105} height={100} alt="sofaaa"></Image>
        ...
        <div className="cartTotal  bg-lightBG text-center w-[20rem] h-[15rem] pt-[4rem] items-center font-Font1 ">
